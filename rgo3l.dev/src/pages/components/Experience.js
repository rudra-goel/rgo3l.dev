...
export default function Experience() {
    ...
    const experiences = [
        {
            ...
            images: [Img13, Img14, Img12, Img17, Img18, Img19, Img20],
            detailedInfo: (
                <>
                    ...
                    <br /><br />
                    Check out our 2025 in-house comp <a href="https://www.youtube.com/watch?v=2dVwJ1jmw80" target="_blank" rel="noopener noreferrer"><span className="link">here</span></a>
                    <br /><br />
        ...
        },
        {
            ...
            images: [Img21, Img22, Img23, Img24, Img25, Img26, Img27, Img28, Img29],
            detailedInfo: (
                <>
                    ...
                    <br /><br /><br />
                    <a href={ors_paper} target="_blank" rel="noopener noreferrer"><span className="link">Paper</span></a>
                    <br /><br /><br />
                    <a href={ors_poster} target="_blank" rel="noopener noreferrer"><span className="link">Poster</span></a>
                </>
            )
        },
        {
            ...
            images: [Img3, Img4, Img5, Img6, Img7, Img8, Img9, Img10, Img11],
            detailedInfo: (
                <>
                    I aided in prototyping neural imaging experiments of the prefrontal cortex to ultimately treat schizophrenia. Initially, I made custom circuits for mice stationed in LickOmeter rigs, <span className="bold-reg-text">but I soon transitioned to work in signal processing.</span>
                    <br /><br />
                    To reduce interference and noise in data postprocessing, I implemented real-time filering algorithms to mitigate distortions in specific stopband frequencies on an FPGA.
                    <br /><br />
                    I also designed and 3D printed parts to interface with lab instruments to aid researchers.
                    <br /><br />
                </>
            )
        },
        {
            ...
            images: null, // No images for this experience
            detailedInfo: (
                <>
    ...
    // Single state object to manage all experience expanded states
    const [expandedExperiences, setExpandedExperiences] = useState(
        experiences.reduce((acc, experience, index) => ({
            ...acc,
            [experience.id]: index === 0 // Only first experience expanded by default
        }), {})
    );
        ...
        return (
            <div className="experience-tile">
                ...
                <div className="experience-footer">
                    ...
                    <div className={`experience-active-${isExpanded}${!experience.images ? '-no-images' : ''}`}>
                        {experience.images && (
                            <div className="slideshow-container">
                                <Slideshow images={experience.images}/>
                            </div>
                        )}
